...
<!-- Mirrored from templates.iqonic.design/findash/html/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Dec 2022 15:54:30 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                        ...
                        <div class="sign-in-from">
                            ...
                            <form class="mt-4" action="{{ route("register") }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old("name") }}" class="form-control mb-0  @error('name') is-invalid @enderror" id="exampleInputEmail1" placeholder="Your Full Name">
                                    @error("name")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="{{ old("email") }}" class="form-control mb-0  @error('email') is-invalid @enderror" id="exampleInputEmail2" placeholder="Enter email">
                                    @error("email")
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation"  class="form-control mb-0 " id="exampleInputPassword1" placeholder="Password">
